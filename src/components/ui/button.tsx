  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring:ring disable:pointer-events-none disable:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-destructive text-destructive-forgrounded shadow-sm hover:bg-destructive/90",
        outline: "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-forgrounded",
        secondary: "bg-secondary text-secondary-forgrounded shadow-sm hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-forgrounded",
